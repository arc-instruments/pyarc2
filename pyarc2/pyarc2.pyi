...
class AuxDACFn:
    ...
    LGC: ClassVar[pyarc2.AuxDACFn] = ...
    @classmethod
    def __init__(cls) -> None: ...

class LogicLevel:
    LL1V8: ClassVar[pyarc2.LogicLevel] = ...
    LL3V3: ClassVar[pyarc2.LogicLevel] = ...
    LL5V: ClassVar[pyarc2.LogicLevel] = ...
    @classmethod
    def __init__(cls) -> None: ...

class OutputRange:
    STD: ClassVar[pyarc2.OutputRange] = ...
    EXT: ClassVar[pyarc2.OutputRange] = ...
    @classmethod
    def __init__(cls) -> None: ...
...
class InstrumentLL:
    ...
    def set_logic_level(self, level: LogicLevel) -> InstrumentLL: ...
    def set_channel_range(self, chans: IntIterable, rng: OutputRange) -> InstrumentLL: ...
    def wait(self) -> None: ...
